...
public class WebTableIteration {
	...
	public void setUp() throws Exception {
		System.setProperty("webdriver.edge.driver","D:\\edgedriver_win64\\msedgedriver.exe"); // Setting the brows
																									// name,Setting path
																									// of the webdriver
...
// FOR WHOLE TABLE (CONTAINS HEADINGS AND BODY)
		List<WebElement> whole = d
				.findElements(By.xpath("//table[@class='dataTable']//tr/th | //table[@class='dataTable']//tr/td"));
