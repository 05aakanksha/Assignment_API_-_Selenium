...
public class ValidationRediffEdge {

	public static void main(String[] args) throws InterruptedException {

		System.setProperty("webdriver.edge.driver", "D:\\edgedriver_win64\\msedgedriver.exe"); // Setting the browser
		...
		driver.findElement(By.id("login1")).sendKeys("aakanksha");
		driver.findElement(By.id("password")).sendKeys("tomar123");
